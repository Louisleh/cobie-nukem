...
| `umbrella_shield_enforcer_atlas.png` | `assets/source/blender/rain_city_umbrella_enforcer.blend` | 8×4 directional idle/locomotion and alert/open/attack/hurt/stagger/shield-break/death/brace vocabulary | `9f17b2bdbe48072372fcf74c306f553d30ea706a1d9a14c9e91c8010c5c64ba2` |
...
Rain City Enforcer contract: the Umbrella Shield Enforcer atlas is rendered deterministically from a project-original Blender model authored entirely from primitives and built-in material nodes. Thirty-two transparent 256×256 frames are composed into a 2048×1024 atlas; no generated-image identity drift, third-party mesh, photograph, logo, or protected character reference is involved. Runtime state transitions select the explicit reaction row and distant actors throttle through the shared production profile.
