...
func _test_manifest() -> void:
	...
	_expect(mission_2_card != null and mission_2_card.unlock_policy == LevelCardData.UnlockPolicy.ALWAYS and mission_2_card.prerequisite_mission_id == &"" and mission_2_card.release_badge == "BETA" and mission_2_card.scene_path == "res://scenes/levels/episode_1_vancouver_waterfront.tscn", "Mission 2 is an always-available public BETA with the production route")
