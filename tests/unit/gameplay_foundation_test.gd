...
func _test_manifest() -> void:
	...
	_expect(mission_2_card != null and mission_2_card.unlocked and mission_2_card.status_badge() == "BETA" and mission_2_card.scene_path == "res://scenes/levels/episode_1_vancouver_waterfront.tscn", "Mission 2 production preview is publicly routable with an explicit BETA badge")
