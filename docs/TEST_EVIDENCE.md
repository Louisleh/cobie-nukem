...
| Complete release/export matrix | Pass | Second `QA_EXPORTS=1 bash tools/release_validate.sh` run completed parser/import, all unit/integration/route/adversarial/content/soak/performance/architecture/IP gates, Web export, and unsigned Universal macOS export with no attributable production error/leak/orphan output |
