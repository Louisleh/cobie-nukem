...
| Chrome public-load trace | Pass | Cache-busted production URL reached the truthful title screen; LCP 204 ms, CLS 0.00, TTFB 34 ms. The only console warning was the expected pre-gesture Web Audio policy warning; no Godot error was observed. |
...
| Public identity | Pass | Source PR #61 merged as `be2b048`; [prerelease `v0.10.0-alpha.1-rc1`](https://github.com/Louisleh/cobie-nukem/releases/tag/v0.10.0-alpha.1-rc1) published; website PR #129 merged as `a80fec3`; ordinary and cache-busted public pages identify runtime `7cb7ac6`; downloaded public PCK is 69,468,616 bytes and byte-identical at SHA-256 `f24a9911c141aefc97c2eb5ad86c87c74e3e87856c484671a9c773e01d9a0aaf` |
