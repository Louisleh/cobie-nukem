...
SKIP_VALIDATION=1 VERSION=0.7.0-alpha.1-rc5 bash tools/package_release.sh
```
...
- `builds/packages/cobie-nukem-0.7.0-alpha.1-rc5-itch.zip` — itch.io Web upload with `index.html` at ZIP root.
- `builds/packages/cobie-nukem-0.7.0-alpha.1-rc5-macos-unsigned.zip` — unsigned macOS build.
