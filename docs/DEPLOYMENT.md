...
- `builds/packages/cobie-nukem-0.2.0-rc1-itch.zip` — itch.io Web upload with `index.html` at ZIP root.
- `builds/packages/cobie-nukem-0.2.0-rc1-macos-unsigned.zip` — unsigned macOS build.
