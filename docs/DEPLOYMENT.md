...
SKIP_VALIDATION=1 VERSION=0.6.0-alpha.5 bash tools/package_release.sh
```
...
- `builds/packages/cobie-nukem-0.6.0-alpha.5-itch.zip` — itch.io Web upload with `index.html` at ZIP root.
- `builds/packages/cobie-nukem-0.6.0-alpha.5-macos-unsigned.zip` — unsigned macOS build.
