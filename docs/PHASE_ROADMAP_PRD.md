...
| Automated gate | **NON-EXPORT MATRIX GREEN** | Parser/import, unit/integration/content/smoke, 100 route/checkpoint/touch/effect cycles, 500 weapon transitions, 100 convoy cycles, asset/IP, architecture, and headless drift/performance pass |
| Release | **PENDING FINAL EXPORT/PUBLICATION** | Full `QA_EXPORTS=1`, packaged Web/native evidence, independent full-diff review, source PR/release, website deployment, and public PCK identity remain before RC publication |
