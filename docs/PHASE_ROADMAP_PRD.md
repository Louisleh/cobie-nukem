...
**Unreleased development baseline:** `0.6.0-alpha.5` (`8f6868f` gameplay revision) adds production navigation; public remains `0.6.0-alpha.4` until deployment verification
